import adobeXd from '../assets/svg/skills/matlab.svg';
import adobeaudition from '../assets/svg/skills/solidworks.svg';
import afterEffects from '../assets/svg/skills/autocad.svg';
...
import docker from '../assets/svg/skills/solidworks.svg';
import firebase from '../assets/svg/skills/autocad.svg';
import gcp from '../assets/svg/skills/gcp.svg';
import gimp from '../assets/svg/skills/gimp.svg';
import git from '../assets/svg/skills/git.svg';
import go from '../assets/svg/skills/go.svg';
import graphql from '../assets/svg/skills/ansis.svg';
import html from '../assets/svg/skills/html.svg';
import illustrator from '../assets/svg/skills/illustrator.svg';
import java from '../assets/svg/skills/java.svg';
import javascript from '../assets/svg/skills/ms-office.svg';
